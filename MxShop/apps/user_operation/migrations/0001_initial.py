# Generated by Django 2.0.2 on 2019-03-20 13:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province', models.CharField(default='', max_length=10, verbose_name='省份')),
                ...
                ('signer_mobile', models.CharField(default='', max_length=11, verbose_name='收货人手机')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='用户')),
            ],
            options={
                'verbose_name': '添加收货地址',
                'verbose_name_plural': '添加收货地址',
            },
        ),
        migrations.CreateModel(
            name='UserFav',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message_type', models.CharField(choices=[(1, '留言'), (2, '投诉'), (3, '咨询'), (4, '售后'), (5, '求购')], default=1, max_length=30, verbose_name='留言类型')),
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='message/file/', verbose_name='文件')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='用户')),
            ],
            options={
