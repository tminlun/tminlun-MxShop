# Generated by Django 2.0.2 on 2019-02-27 10:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.Goods', verbose_name='订单的商品')),
            ],
            options={
                'verbose_name': '商品订单',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nonce_str', models.CharField(blank=True, max_length=50, null=True, unique=True, verbose_name='微信支付随机加密串')),
